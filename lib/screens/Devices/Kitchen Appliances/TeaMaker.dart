...
class TeaMaker extends StatefulWidget {
  const TeaMaker({super.key});

  @override
  State<TeaMaker> createState() => _TeaMakerState();
}

class _TeaMakerState extends State<TeaMaker> {
  @override
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DevicePair(
                img: "assets/images/devices/TeaMaker.svg",
