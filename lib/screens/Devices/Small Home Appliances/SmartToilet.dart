...
class SmartToilet extends StatefulWidget {
  const SmartToilet({super.key});

  @override
  State<SmartToilet> createState() => _SmartToiletState();
}

class _SmartToiletState extends State<SmartToilet> {
  @override
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DevicePair(
                img: "assets/images/devices/SmartToilet.svg",
