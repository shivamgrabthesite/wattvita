...
class StringLight extends StatefulWidget {
  const StringLight({super.key});

  @override
  State<StringLight> createState() => _StringLightState();
}

class _StringLightState extends State<StringLight> {
  @override
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DevicePair(
                img: "assets/images/devices/StringLight.svg",
