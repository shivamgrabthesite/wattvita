...
class DimmerSwitch extends StatefulWidget {
  const DimmerSwitch({super.key});

  @override
  State<DimmerSwitch> createState() => _DimmerSwitchState();
}

class _DimmerSwitchState extends State<DimmerSwitch> {
  @override
